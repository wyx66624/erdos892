...
\begin{enumerate}
\item for quasi-primitive inputs, an arithmetic erasure of the Hasse parent/type
      labels and cross-rank divisibility with uniformly bounded dilation, or a genuine
      divergent obstruction;
...
show, on the first side, that every local quasi-primitive Hasse palette requires at most
one binary bit under an immediate-shadow compression and, on the second side, that a broad
